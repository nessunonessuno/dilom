...
export default function Portfolio() {
  ...
  <Text align="left" sx={{fontSize:"20px", fontFamily:"IBM Plex Sans"}}>
    <UnorderedList>
      ...
      <ListItem sx={{marginBottom:"10px"}}>Creazione di Smart contract su misura delle esigenze</ListItem>
      <ListItem sx={{marginBottom:"10px"}}>Creazione di siti web crypto basati sulla tecnologia blockchain e criptovalute, come Ethereum, con l&apos;utilizzo di Smart Contract con Solidity</ListItem>
